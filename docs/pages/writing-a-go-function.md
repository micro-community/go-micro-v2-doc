...
If you prefer a higher level overview of the toolkit first, checkout the introductory blog post [https://micro-community.github.io/website/blog/2016/03/20/micro.html](https://micro-community.github.io/website/blog/2016/03/20/micro.html).
...
Upon serving a request the function will exit. You can use [micro run](https://micro-community.github.io/website/docs/run.html) to manage the lifecycle 
