...
[**Micro**](https://micro-community.github.io/m3o-web) is 5 years in the making now and through that time the tools in our industry have drastically changed. 
We're moving towards cloud-native being the defacto standard for how we build software.

Our vision from day 1 was always around [Microservices](https://micro-community.github.io/m3o-web/blog/2016/03/17/introduction.html) and the 
power of what it unlocks insides orgs that buy into this form of development. We also fundamentally believed 
in [RPC](https://micro-community.github.io/m3o-web/blog/2016/03/20/micro.html) and the direction of these patterns based on our 
...
Join our #platform channel on [Slack](https://micro-community.github.io/m3o-web/community) to be the first to try it out.
